...
1. [APPLY](./apply/apply): The fifth part consists of some small case studies. We will apply the features we have learned in the previous parts to implement these applications.
