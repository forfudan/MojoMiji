# Useful resources and links for Mojo

1. [Mojo official website](https://mojolang.org/): The official documentation for Mojo, which provides comprehensive information about the language, its features, and how to use it.
1. [Mojo releases & changelog](https://mojolang.org/releases/): A record of changes made to the Mojo language, including new features, bug fixes, and improvements.
